...
let of_list_test =
  "of_list"
  >::: [
         ("複数要素" >:: fun _ -> assert_equal (Cons (1, Cons (2, Last 3))) (of_list [1; 2; 3]));
         ("単一要素" >:: fun _ -> assert_equal (Last 1) (of_list [1]));
...
let hd_test =
  "hd"
  >::: [
         ("先頭要素を返す" >:: fun _ -> assert_equal_int 1 (hd @@ of_list [1; 2; 3]));
         ("先頭要素を返す2" >:: fun _ -> assert_equal_int 1 (hd @@ of_list [1]));
       ]

let tl_test =
  "tl"
  >::: [
         ("tail を返す" >:: fun _ -> assert_equal (Cons (2, Last 3)) (tl @@ of_list [1; 2; 3]));
         (* TODO: 空リストが渡ったケースのテスト *)
       ]
...
let last_test =
  "last"
  >::: [
         ("末尾の要素を返す" >:: fun _ -> assert_equal_int 3 (last @@ of_list [1; 2; 3]));
         ("末尾の要素を返す2" >:: fun _ -> assert_equal_int 1 (last @@ of_list [1]));
       ]

let fold_left_test = "fold_left" >::: []

let length_test =
  "length"
  >::: [
         ("複数要素" >:: fun _ -> assert_equal_int 3 (length @@ of_list [1; 2; 3]));
         ("単一要素" >:: fun _ -> assert_equal_int 1 (length @@ of_list [1]));
       ]
...
let rev_test =
  ...
  >::: [
         ...
         ("単一要素" >:: fun _ -> assert_equal (Last 1) (rev @@ of_list [1]));
       ]
...
let map_test =
  ...
  >::: [
         ...
         ("単一要素" >:: fun _ -> assert_equal (Last 2) (map (( + ) 1) @@ of_list [1]));
       ]
...
let create_test =
  "create"
  >::: [
         ("複数要素" >:: fun _ -> assert_equal (Cons (1, Cons (2, Last 3))) (create [1; 2] 3));
         ("単一要素" >:: fun _ -> assert_equal (Last 1) (create [] 1));
       ]

let to_list_test =
  "to_list"
  >::: [
         ("複数要素" >:: fun _ -> assert_equal_intlist [1; 2; 3] (to_list @@ of_list [1; 2; 3]));
         ("単一要素" >:: fun _ -> assert_equal_intlist [1] (to_list @@ of_list [1]));
       ]
...
let sort_test =
  ...
  >::: [
         ...
         ("単一要素" >:: fun _ -> assert_equal (Last 1) (sort compare @@ of_list [1]));
       ]
...
let max_test =
  ...
  >::: [
         ...
         ("単一要素の場合" >:: fun _ -> assert_equal_int 1 (max compare @@ of_list [1]));
       ]
...
let min_test =
  ...
  >::: [
         ...
         ("単一要素の場合" >:: fun _ -> assert_equal_int 1 (min compare @@ of_list [1]));
       ]
